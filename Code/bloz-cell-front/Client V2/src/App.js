...
class App extends React.Component {
  ...
  validate = () => {
    ...
    if (form.nombre.length < 10) {
      errors.nombre = "Se necesitan al menos 10 caracteres.";
    }
    ...
    if (form.marca.length < 10) {
      errors.marca = "Se necesitan al menos 10 caracteres.";
    }
    ...
    if (form.modelo.length < 10) {
      errors.modelo = "Se necesitan al menos 10 caracteres.";
    }
    ...
    if (form.caracteristicas.length < 10) {
      errors.caracteristicas = "Se necesitan al menos 10 caracteres.";
    }
